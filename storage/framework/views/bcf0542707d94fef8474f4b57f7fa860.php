...
<?php $component->withAttributes([]); ?>
    <main>
        <form method="POST" action="<?php echo e(route('register')); ?>" class="form-container">
            ...
            <input type="email" id="email" placeholder="Apple ID">
        ...
        <a class="button" href="<?php echo e(route('google')); ?>">
            ...
            <a class="button" href="<?php echo e(route('celular')); ?>">
...
<?php endif; ?><?php /**PATH /home/andrade/Documents/Proyectos/php/uber/resources/views/auth/apple.blade.php ENDPATH**/ ?>