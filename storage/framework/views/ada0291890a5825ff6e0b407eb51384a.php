...
<?php $component->withAttributes([]); ?>
    <main>
        <form method="POST" class="form-container" action="<?php echo e(route('login')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="forgot-password">
                <a href="<?php echo e(route('olvido-contrasena')); ?>">¿Olvidaste la contraseña?</a>
            </div>
        </form>
    </main>
    <footer>
...
<?php endif; ?><?php /**PATH /home/andrade/Documents/Proyectos/php/uber/resources/views/auth/inicio.blade.php ENDPATH**/ ?>