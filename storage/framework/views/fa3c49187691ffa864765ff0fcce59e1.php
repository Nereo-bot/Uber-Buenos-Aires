...
<?php $component->withAttributes([]); ?>
    <div class="container">
        ...
        <h1>Como desea pagar <span>$<?php echo e($price); ?></span>?</h1>
        <div class="payment-options">
            <form action="<?php echo e(route('tarjeta')); ?>" method="post">
                <?php echo csrf_field(); ?>
            ...
            <form action="<?php echo e(route('disfrute')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="price" value="<?php echo e($price); ?>">
                <input type="hidden" name="nombre_chofer" value="<?php echo e($nombre_chofer); ?>">
                <button class="btn-card">
...
<?php endif; ?><?php /**PATH /home/andrade/Documents/Proyectos/php/uber/resources/views/pagos/pago.blade.php ENDPATH**/ ?>